 ...
 */
package com.plaid.platform.porcelain.common.mock;
...
import com.plaid.platform.porcelain.R;
...
public final class MockDatabase {
    ...
    public static class BigPictureStyleSocialAppData extends MockNotificationData {
        ...
        private BigPictureStyleSocialAppData() {
            ...
            mContentTitle = "Transfer Funds";
            mContentText = "You donate $5 threshold is reached.";
            mPriority = NotificationCompat.PRIORITY_HIGH;

            // Style notification values:
            mBigImage = R.drawable.ic_notification;
            mBigContentTitle = "Transfer Funds";
            mSummaryText = "You donate $5 threshold is reached.\n" +
                    "Do you want to donate?";

            // This would be possible responses based on the contents of the post.
            mPossiblePostResponses = new CharSequence[] {"Yes", "No"};
        ...
        private MessagingStyleCommsAppData(Context context) {
            ...
            mMessages.add(
                    ...
                    new MessagingStyle.Message("", 1528490641998l, participant1)
                            .setData("image/png", resourceToUri(context, R.drawable.ic_notification)));
